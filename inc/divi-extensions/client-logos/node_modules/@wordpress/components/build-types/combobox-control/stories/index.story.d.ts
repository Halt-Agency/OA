...
export default meta;
export declare const Default: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react").ReactRenderer, Pick<import("../../base-control/types").BaseControlProps, "className" | "label" | "help" | "hideLabelFromVision" | "__nextHasNoMarginBottom"> & {
 ...
 */
export declare const WithCustomRenderItem: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react").ReactRenderer, Pick<import("../../base-control/types").BaseControlProps, "className" | "label" | "help" | "hideLabelFromVision" | "__nextHasNoMarginBottom"> & {
    __experimentalRenderItem?: ((args: {
        item: import("../types").ComboboxControlOption;
    }) => import("react").ReactNode) | undefined;
    __next36pxDefaultSize?: boolean | undefined;
