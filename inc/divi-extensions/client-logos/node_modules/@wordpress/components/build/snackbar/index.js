...
function UnforwardedSnackbar({
  ...
  if (actions && actions.length > 1) {
    ...
    typeof SCRIPT_DEBUG !== "undefined" && SCRIPT_DEBUG === true ? (0, _warning.default)('Snackbar can only have one action. Use Notice if your message requires many actions.') : void 0;
