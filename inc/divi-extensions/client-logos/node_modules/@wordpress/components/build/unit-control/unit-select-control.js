...
function UnitSelectControl({
  ...
  if (!(0, _utils.hasUnits)(units) || units?.length === 1) {
    return (0, _react.createElement)(_unitControlStyles.UnitLabel, {
  ...
  return (0, _react.createElement)(_unitControlStyles.UnitSelect, {
    ref: ref,
    className: classes,
    ...
    value: unit,
    ...props
  }, units.map(option => (0, _react.createElement)("option", {
    value: option.value,
    key: option.value
  }, option.label)));
}
