<?php
/**
 * Plugin Name: Halt Tracker Integration
 * Description: Captures Divi form submissions or webhook payloads and forwards them to Tracker RMS via the REST API. Provides queueing, logging, and manual retries.
 * Version: 0.1.0
 * Author: Halt
 * Author URI: https://www.halt.agency
 */
...
final class Halt_Tracker_Plugin {
    ...
    public function enqueue_admin_assets( $hook ) {
        ...
        $css_file   = __DIR__ . '/assets/halt-jobsync.css';
        $js_file    = __DIR__ . '/assets/halt-jobsync.js';
...
register_activation_hook( __FILE__, [ 'Halt_Tracker_Plugin', 'activate' ] );
register_deactivation_hook( __FILE__, [ 'Halt_Tracker_Plugin', 'deactivate' ] );
